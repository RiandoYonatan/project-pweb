...
const Abotus = ({ inactive, toggleoff }) => {
  const teamMembers = [
    ...
    { name: 'Riando Yonatan Mangunsong ', npm: '51421298', class: '3IA12' },
    { name: 'sukamto Irvan Azis ', npm: '51421440', class: '3IA12' },
    { name: 'Muhammad Firzal Anugerah Perdana ', npm: '51421617', class: '3IA12' },
  ];
